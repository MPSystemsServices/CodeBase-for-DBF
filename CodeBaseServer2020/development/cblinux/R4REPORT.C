...
/* MouseEat */
   ...
   ***************************************************************************/
   ...
   int S4FUNCTION report4caption( PREPORT4 report, char S4PTR *caption )
   {
      ...
      report->report_caption = (LPTSTR)u4allocFree( report->codeBase, (strlen(caption)+1) * sizeof(TCHAR) );
      if( !report->report_caption )
      {
      ...
      #ifdef S4UNICODE
         c4atou(caption, report->report_caption, (strlen(caption)+1) * sizeof(TCHAR));
      #else
