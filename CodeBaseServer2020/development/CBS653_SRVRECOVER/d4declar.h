...
/* Possibly Unsupported functions */
   ...
   /* LY 2001/09/13 : added functions for UNIX (which uses 4 byte wchar_t )*/
   WSTR5 * c4wcscpy( WSTR5 *, const WSTR5 * ) ;
   int c4wcscmp( const WSTR5 *, const WSTR5 * ) ;
   void c4mbsToWcs( WSTR5 *, const char*, int ) ;
   void c4wcsToMbs( char *, const WSTR5 *, int ) ;
#else
   #define c4wcslen( a ) wcslen( a )
   #define c4wcscpy( a, b ) wcscpy( a, b )
   #define c4wcscmp( a, b ) wcscmp( a, b )
#endif
#ifdef S4NO_TOUPPER
   char toupper(char) ;
#endif
...
S4EXPORT long S4FUNCTION date4yymmddToJulianLong( const int year, const int month, const int day ) ;
   ...
   S4EXPORT int S4FUNCTION c4stricmp(char *, char *) ;
#endif
...
S4EXPORT int S4FUNCTION code4swapLogFile( CODE4 *, char *, int ) ;
   ...
   S4EXPORT short S4FUNCTION code4unlockAutoSetCB( CODE4 *, short ) ;
#endif
...
S4EXPORT long S4FUNCTION d4recCountDo( DATA4 S4PTR * ) ;
   ...
   #define d4recWidth( d4 ) dfile4recWidth( (d4)->dataFile )
#else
...
S4EXPORT long S4FUNCTION u4switch( void ) ;  /* used for example start-up verification */
   ...
   S4EXPORT void S4FUNCTION code4errorCallback( CODE4 S4PTR *c4, ERROR_CALLBACK errorCallback ) ;  // CS 2001/03/26 add
...
#ifndef S4STAND_ALONE
   #ifdef S4SERVER
      S4EXPORT void S4FUNCTION code4enterExclusive( CODE4 *, struct SERVER4CLIENTSt *, int doDelay = 1 ) ;
      S4EXPORT void S4FUNCTION code4exitExclusive( CODE4 *, struct SERVER4CLIENTSt * ) ;
      #ifdef E4ANALYZE
         S4EXPORT void S4FUNCTION code4enterExclusiveVerifyFirst( CODE4 *, struct SERVER4CLIENTSt *, int doDelay ) ;
         S4EXPORT void S4FUNCTION code4exitExclusiveVerifyLast( CODE4 *, struct SERVER4CLIENTSt * ) ;
      #else
...
int d4tagSyncDo( DATA4 S4PTR *, TAG4 S4PTR * const, int ) ;
   ...
   #ifdef S4SERVER
      int d4unlockData( DATA4 *, long clientId ) ;
      int S4FUNCTION d4unlockAppend( DATA4 *, long clientId ) ;  // CS 2001/01/16 add S4FUNCTION
      int d4unlockRecords( DATA4 *, long clientId ) ;
      int d4unlockFile( DATA4 *, long clientId ) ;
   #else
      #ifdef __cplusplus
         int d4unlockData( DATA4 *, long clientId = -1 ) ;
         S4EXPORT int S4FUNCTION d4unlockAppend( DATA4 *, long clientId = -1 ) ;
         int d4unlockRecords( DATA4 *, long clientId = -1 ) ;
         int d4unlockFile( DATA4 *, long clientId = -1 ) ;
      #else
         int d4unlockData( DATA4 *, long clientId ) ;
...
S4EXPORT int S4FUNCTION l4check( LIST4 S4PTR * ) ;
...
#define mem4createAlloc( a, b, c, d, e, f ) mem4createAllocZero( a, b, c, d, e, f )
   ...
   #define mem4createAllocNoZero( a, b, c, d, e, f ) mem4createAllocDefault( a, b, c, d, e, f, 0 )
      ...
      int memo4fileWritePart( MEMO4FILE *, long *, const char *, const long, const long, const unsigned int, const long ) ;
         ...
         #define memo4fileRead( m4, id, pp, pl, tp ) memo4fileReadPart( (m4), (id), (pp), (pl), (0L), (UINT_MAX - 100), (tp) )
      #else
...
#define u4allocErr( a, b ) ( u4allocEr( (a), (b) ) )
   ...
   S4EXPORT FIXED4MEM S4FUNCTION u4printAllocFixed( CODE4 S4PTR *, long, const char *file, int line ) ;
   #define u4allocFixed( a, b ) u4printAllocFixed( (a), (b), __FILE__, __LINE__ )
   ...
   S4EXPORT void S4FUNCTION u4printFreeFixed( FIXED4MEM, const char *file, int line ) ;
   #define u4freeFixed( a ) u4printFreeFixed( (a), __FILE__, __LINE__ )
#else
...
void u4createCopyrightFromStamp(char *) ;
