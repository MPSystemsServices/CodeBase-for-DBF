...
#Else
    ...
    Declare Function code4encryptConnection& Lib "c4dll.dll" (ByVal c4&, ByVal level&, ByVal numBits&)
...
Global Const r4passwordEncryption = 1
Global Const r4publicEncryption = 2
...
Global Const e4encryptRequired = -1395
