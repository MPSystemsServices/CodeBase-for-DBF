...
@REM cl -DS4SERVER -DWIN32 %1 %2 %3 %4 %5 %6 %7 %8 %9 -nologo -c -MT %COMPOPTS% %COMP_DEB_OPT% -W3 -Zp1 -Tp d4srvApp.c > %OUTPUT%\out
@REM @if exist s4server.exe erase s4server.exe
rc s4server >> %OUTPUT%\out
@REM link %DEBUG% /OUT:%OUTPUT%\s4server.exe d4srvApp S4SERVER.RES %OUTPUT%\S4DLL.LIB %STDLIBS% >> %OUTPUT%\out

@rem build service
cl -DS4SERVER -DWIN32 %1 %2 %3 %4 %5 %6 %7 %8 %9 -nologo -MT %COMPOPTS% %COMP_DEB_OPT% -W3 -Zp1 -Tp d4service.c /link /MACHINE:X86 %DEBUG% /out:%OUTPUT%\s4service.exe %OUTPUT%\S4DLL.LIB %STDLIBS% S4SERVER.RES > %OUTPUT%\out
