...
ReportEvent(hEventLog, EVENTLOG_INFORMATION_TYPE, 0, 1002, 0, 1, 0, (LPCTSTR*)pp, 0);
   ...
   BOOL r = server4taskbarIcon(NIM_ADD, NULL);  // CS 2002/07/24 move to function in d4main.c
sprintf(p, "In service4start %d %d.", r, GetLastError());
ReportEvent(hEventLog, EVENTLOG_INFORMATION_TYPE, 0, 1002, 0, 1, 0, (LPCTSTR*)pp, 0);
