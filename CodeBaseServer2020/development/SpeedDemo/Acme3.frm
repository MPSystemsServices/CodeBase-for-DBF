VERSION 5.00
Begin VB.Form Form3 
   Caption         =   "CodeBase Speed Demo - Query Results"
   ClientHeight    =   3960
   ClientLeft      =   1215
   ClientTop       =   1830
   ClientWidth     =   7290
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label10 
         Caption         =   "Email: info@codebase.com"
         Height          =   255
         Left            =   240
         TabIndex        =   3
         Top             =   1440
...
Loop
time2 = GetTickCount
lblAddInfo.caption = counter & " records in result set. The time to traverse entire set was " & (time2 - time1) / 1000 & " seconds."
rc = relate4top(relation)
Command1.caption = "Time Traversal"
Call refreshlabels
